...
export type GetCurrentUserQuery = (
  ...
  & { currentUser: (
    { __typename?: 'User' }
    & Pick<User, 'firstName' | 'lastName' | 'phoneNumber' | 'email' | 'chulaId' | 'district' | 'province' | 'zipCode' | 'address' | 'profilePictureUrl' | 'didSetup' | 'gender'>
  ) }
);

export type GetQuestionsByEventIdQueryVariables = Exact<{ [key: string]: never; }>;


export type GetQuestionsByEventIdQuery = (
  { __typename?: 'Query' }
  & { event: (
    { __typename?: 'Event' }
...
export type GetUpcomingEventsQuery = (
  ...
  & { upcomingEvents: Array<(
    { __typename?: 'Event' }
    & Pick<Event, 'description' | 'name' | 'profileImageUrl' | 'profileImageHash'>
    & { location?: Maybe<(
      { __typename?: 'Location' }
      & Pick<Location, 'name'>
    )>, tags: Array<(
...
export type AuthenticateMutation = (
  ...
  & { authenticate: (
    { __typename?: 'AuthenticateOutput' }
    & Pick<AuthenticateOutput, 'accessToken'>
  ) }
);
